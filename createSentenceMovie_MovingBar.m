function createSentenceMovie_MovingBar(wordChArray, numberToPlot, colours, word_spacing, bg_colour, barWidth, barInterval, barColour, barChangeCol, movie_filename, fps, nFrames, nFrPause)
% createSentenceMovie_MovingBar(wordChArray, colours, word_spacing, bg_colour, ...
...
%       barWidth            Integer to specify bar width.
%       barInterval         Float specifying the interval that the bar 
%                           should move from frame to frame
%       barColour           Colour specification for bar, in the format
%                           'r' or [0 0 0].
...
[~, all_word_startpos] = plotSentence(wordChArray, leftpos, ...
    word_spacing, text_size, font, colours, fig_height);
...
movieMaker_MovingBar(hFig, fig_pos, barHeight, barWidth, barInterval, ...
    barColour, barChangeCol, fps, nFrames, nFrPause, all_word_startpos, ...
    movie_filename);
